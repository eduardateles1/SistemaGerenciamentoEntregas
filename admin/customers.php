    ...
    <div class="card mt-4 shadow-sm">
        <div class="card-header">
            <h4 class="mb-0">Clientes
                <a href="customers-create.php" class="btn btn-primary float-end ms-2">Adicionar Cliente</a>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-success btn-sm"
                                    href="customers-edit.php?id=<?= $item['id']; ?>">Editar</a>
                                <a class="btn btn-danger btn-sm" href="customers-delete.php?id=<?= $item['id']; ?>"
